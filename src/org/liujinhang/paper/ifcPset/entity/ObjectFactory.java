 ...
 * element interface generated in the org.liujinhang.paper.ifc.Pset.entity
 * package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _PropertyDefPropertyType_QNAME = new QName("",
			"PropertyType");
	private final static QName _PropertyDefNameAliases_QNAME = new QName("",
			"NameAliases");
	private final static QName _PropertyDefDefinitionAliases_QNAME = new QName(
			"", "DefinitionAliases");
	private final static QName _PropertyDefValueDef_QNAME = new QName("",
			"ValueDef");
	private final static QName _PropertyDefDefinition_QNAME = new QName("",
			"Definition");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.liujinhang.paper.ifc.Pset.entity
	 * 
	 */
	...
	public JAXBElement<String> createPropertyDefName(String value) {
		return new JAXBElement<String>(_PropertyDefName_QNAME, String.class,
				PropertyDef.class, value);
	}
	...
	public JAXBElement<PropertyType> createPropertyDefPropertyType(
			PropertyType value) {
		return new JAXBElement<PropertyType>(_PropertyDefPropertyType_QNAME,
				PropertyType.class, PropertyDef.class, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link PropertyDef.NameAliases }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "NameAliases", scope = PropertyDef.class)
	public JAXBElement<PropertyDef.NameAliases> createPropertyDefNameAliases(
			PropertyDef.NameAliases value) {
		return new JAXBElement<PropertyDef.NameAliases>(
				_PropertyDefNameAliases_QNAME, PropertyDef.NameAliases.class,
				PropertyDef.class, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link PropertyDef.DefinitionAliases }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "DefinitionAliases", scope = PropertyDef.class)
	public JAXBElement<PropertyDef.DefinitionAliases> createPropertyDefDefinitionAliases(
			PropertyDef.DefinitionAliases value) {
		return new JAXBElement<PropertyDef.DefinitionAliases>(
				_PropertyDefDefinitionAliases_QNAME,
				PropertyDef.DefinitionAliases.class, PropertyDef.class, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link PropertyDef.ValueDef }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "ValueDef", scope = PropertyDef.class)
	public JAXBElement<PropertyDef.ValueDef> createPropertyDefValueDef(
			PropertyDef.ValueDef value) {
		return new JAXBElement<PropertyDef.ValueDef>(
				_PropertyDefValueDef_QNAME, PropertyDef.ValueDef.class,
				PropertyDef.class, value);
	}
	...
	public JAXBElement<String> createPropertyDefDefinition(String value) {
		return new JAXBElement<String>(_PropertyDefDefinition_QNAME,
				String.class, PropertyDef.class, value);
	}
